               ...
               <div className="space-y-12 lg:sticky lg:top-32">
                  ...
                  <div className="bg-taupe-500/10 p-10 rounded-3xl border border-taupe-500/20">
                     ...
                     <Link
                        ...
                        className="group inline-flex items-center gap-4 px-10 py-5 bg-charcoal-900/90 dark:bg-stone-dark/90 backdrop-blur-md border border-stone-200/50 dark:border-white/10 text-white/90 dark:text-gray-300 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] shadow-lg hover:shadow-2xl hover:bg-mantle dark:hover:bg-mantle hover:-translate-y-1 transition-all duration-400"
                     >
                        {t.cta_btn}
