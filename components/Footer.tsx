...
const Footer: React.FC<FooterProps> = ({ theme, toggleTheme }) => {
  ...
  return (
    <footer className={clsx("pt-12 pb-8 md:pt-20 md:pb-12 px-6 text-sm mt-auto transition-colors duration-500 relative z-40", containerClass)}>
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 border-b border-stone-200 dark:border-white/10 pb-12 md:pb-16">

        {/* Brand */}
        <div className="md:col-span-4 flex flex-col items-center md:items-start text-center md:text-left">
          <Link to={`/${currentLang}`} className={clsx(brandClass, "text-2xl md:text-3xl")}>
            {t.brand}
          </Link>
